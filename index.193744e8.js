...
var _tipJs = require("../js/tip.js");

},{"../scss/style.scss":"1zc1D","../js/tip.js":"8kvra"}],"1zc1D":[function() {},{}],"8kvra":[function(require,module,exports) {
...
function empty() {
    if (bill.value == "" && tipInput.value == "" && peopleNumber.value == "") resetBtn.classList.add("empty");
    else resetBtn.classList.remove("empty");
}
